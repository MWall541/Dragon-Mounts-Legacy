...
public class DMLRegistry
{
    ...
    public static final RegistryObject<Attribute> RANGED_DAMAGE = register("dragon.ranged.damage", Registries.ATTRIBUTE,  () -> new RangedAttribute("attribute.name.dragon.ranged_damage", 2, 0, 2048));
