...
public class BlueFireDragonBreathBall extends LargeFireball {
    ...
    public BlueFireDragonBreathBall(EntityType<? extends BlueFireDragonBreathBall> type, Level level) {
        super(type, level);
    ...
    public BlueFireDragonBreathBall(Level level, LivingEntity shooter, double dx, double dy, double dz, int power) {
        // Call our OWN first constructor using the Registry Type
        this(DMLRegistry.BLUE_FIRE_BREATH.get(), level);
    ...
    protected boolean canHitEntity(@NotNull Entity target) {
        ...
        if (target instanceof BlueFireDragonBreathBall) {
            return false;
        }
