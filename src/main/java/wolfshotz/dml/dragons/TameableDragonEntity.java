...
import wolfshotz.dml.dragons.ai.DragonBodyController;
import wolfshotz.dml.dragons.ai.DragonMoveController;
import wolfshotz.dml.dragons.ai.LifeStageController;
import wolfshotz.dml.dragons.ai.goals.*;
...
public class TameableDragonEntity extends TameableEntity
{
    ...
    protected void registerGoals() // TODO: Much Smarter AI and features
    {
        ...
        if (getType() != DMLRegistry.WATER_DRAGON.get())
        {
    ...
    protected SoundEvent getAmbientSound()
    {
        ...
        return DMLRegistry.DRAGON_BREATHE.get();
    }
    ...
    public SoundEvent getStepSound() { return DMLRegistry.DRAGON_STEP.get(); }

    /**
     * Returns the sound this mob makes on death.
     */
    @Override
    protected SoundEvent getDeathSound() { return DMLRegistry.DRAGON_DEATH.get(); }
    ...
    public AgeableEntity createChild(AgeableEntity mate)
    {
        ...
        DragonEggEntity egg = new DragonEggEntity(DragonEggType.lookUp(getType()), world);
        if (getRNG().nextBoolean()) egg = new DragonEggEntity(DragonEggType.lookUp(mate.getType()), world);
