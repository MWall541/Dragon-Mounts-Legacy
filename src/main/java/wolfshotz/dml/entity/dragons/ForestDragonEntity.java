...
public class ForestDragonEntity extends TameableDragonEntity
{
    ...
    public static boolean isHabitat(DragonEggEntity egg)
    {
        ...
        return BlockPos.getAllInBox(pos1, pos2)
                ...
                .anyMatch(new BetterBlockMatcher(BlockTags.LEAVES.getAllElements())
                        .add(BlockTags.SAPLINGS.getAllElements())
                        .add(BlockTags.LOGS.getAllElements())
                        .add(Blocks.MOSSY_COBBLESTONE, Blocks.VINE));
    }
}
